...
export default function LoginPage() {
  ...
  return (
    <>
      <style jsx global>{`
        body { font-family: 'Poppins', 'Vazirmatn', sans-serif; background: #f9fbfc; color: #1a2e44; min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 20px; }
        ...
        .field input { width: 100%; padding: 11px 14px; font-family: 'Poppins', 'Vazirmatn', sans-serif; font-size: 0.88rem; color: #1a2e44; background: #fff; border: 1px solid #d8e3ec; border-radius: 7px; outline: none; transition: border-color 0.2s ease; }
        .field input:focus { border-color: #2db5c0; box-shadow: 0 0 0 3px rgba(45,181,192,0.08); }
        .field input::placeholder { color: #b8c9d6; }
        .login-btn { width: 100%; padding: 12px; margin-top: 8px; font-family: 'Poppins', 'Vazirmatn', sans-serif; font-size: 0.88rem; font-weight: 600; color: #fff; background: #2db5c0; border: none; border-radius: 7px; cursor: pointer; transition: background 0.2s ease; position: relative; }
